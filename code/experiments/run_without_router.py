...
class E3LLMEnhancedExperiment:
    ...
    def __init__(self):
        ...
        self.output_file = os.path.join(self.output_dir, "E3_llm_enhanced_results.json")
        self.detailed_file = os.path.join(self.output_dir, "E3_llm_enhanced_detailed.jsonl")
        self.routing_log_file = os.path.join(self.output_dir, "E3_routing_log.jsonl")
    ...
    def generate_answer(self, instruction: str, predicted_module: str) -> Tuple[str, float]:
        ...
        try:
            if predicted_module == 'biomass':
                ...
                predicted_answer = self.forestry_qa.process(instruction)
