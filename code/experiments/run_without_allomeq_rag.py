...
class E3LLMEnhancedExperiment:
    ...
    def __init__(self):
        ...
        self.output_file = os.path.join(self.output_dir, "E3_no_allomeq_rag_results.json")
        self.detailed_file = os.path.join(self.output_dir, "E3_no_allomeq_rag_detailed.jsonl")
        self.routing_log_file = os.path.join(self.output_dir, "E3_no_allomeq_rag_routing_log.jsonl")
    ...
    def generate_answer(self, instruction: str, predicted_module: str):
        ...
        try:
            ...
            if predicted_module == "biomass":
                ...
                result = self.forestry_qa.process(
                    instruction
                )
                ...
                result = self.general_chat.process(
                    instruction
                )
